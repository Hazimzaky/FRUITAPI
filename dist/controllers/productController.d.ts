...
export declare const getProductStats: (req: Request, res: Response, next: import("express").NextFunction) => void;
export declare const bulkDeleteProducts: (req: Request, res: Response, next: import("express").NextFunction) => void;
